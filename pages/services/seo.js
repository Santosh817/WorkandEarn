    ...
    const ProjectListI = [
        {
            ...
            des: "A 500 words SEO in 24 hours",
            f_left: {
                textI: "From",
                textII: "$30"
            },
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <header className="header-bg">
                ...
                <ServiceSearch
                    textI = "Marketing"
                    textII = "Search Marketing"
                    headText = "SEO"
                    des = "Help your site show up on search engines with professional SEO services."
            ...
            <main>
                ...
                <SerFirProjectSec
                    ...
                    des="SEO posts projects available"
                    projectList={ProjectListI}
                />

                {/* ======================== Second Section =========================== */}
                <SeSecProjectSec
                    headText = "Top minimalist SEO & Blog Posts projects"
                ...
                {/* ======================== Third Section =========================== */}
                <SeThiProjectSec
                    headText = "Top minimalist SEO Posts projects"
                    des="These Writter will create a simple, bold seo that makes your brand unforgettable"
                ...
                {/* ============================ Eight Section ============================ */}
                <SeEigProjectSec
                    headText="SEO Related Articles"
                    projectList={ProjectListVIII}
                />

                {/* ============================ Last Section ============================ */}
                <ServiceList
                    headText="Browse Related SEO Services"
