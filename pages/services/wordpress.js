    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <header className="header-bg">
                ...
                {/* ======================== Container Section =========================== */}
                <ServiceSearch
                    textI = "Development & It"
                    textII = "Development"
                    headText = "Wordpress"
                    des = "These WordPress development pros can design and develop sites that boost."
            ...
            <main>
                ...
                {/* ======================== Second Section =========================== */}
                <SeSecProjectSec
                    headText = "Top minimalist Wodpress projects"
                    des="These designers will create a simple, bold Wordpress that makes your brand unforgettable"
                    projectList={ProjectListII}
                />

                {/* ======================== Third Section =========================== */}
                <SeThiProjectSec
                    headText = "Top minimalist Wordpress projects"
                    des="These designers will create a simple, bold wordpress that makes your brand unforgettable"
                ...
                {/* ============================ Eight Section ============================ */}
                <SeEigProjectSec
                    headText="Wordpress Design Related Articles"
                    projectList={ProjectListVIII}
                />

                {/* ============================ Last Section ============================ */}
                <ServiceList
                    headText="Browse Related Wordpress Design Services"
