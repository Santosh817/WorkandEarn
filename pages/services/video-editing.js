        ...
        <div className="min-h-screen flex flex-col">
            ...
            <header className="header-bg">
                ...
                <Navbar/>
                 ...
                 <ServiceSearch
                    textI = "Video Editing"
                    textII = "Social Media Editing"
                    headText = "Video Editing"
            ...
            <main>
                ...
                {/* ======================== Second Section =========================== */}
                <SeSecProjectSec
                    headText = "Top minimalist Video Editing projects"
                    des="These designers will create a simple, bold Editng that makes your brand unforgettable"
                ...
                <SeThiProjectSec
                    headText = "Top minimalist Video Editing projects"
                    des="These designers will create a simple, bold Editing that makes your brand unforgettable"
                ...
                {/* ============================ Eight Section ============================ */}
                <SeEigProjectSec
                    headText="Video Editing Related Articles"
                    projectList={ProjectListVIII}
                />

                {/* ============================ Last Section ============================ */}
                <ServiceList
                    headText="Browse Related Video Editing Design Services"
