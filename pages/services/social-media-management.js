    ...
    const ProjectListI = [
        {
            ...
            des: "A 500 words SEO articles or blog in 24 hours",
            f_left: {
                textI: "From",
                textII: "$30"
            },
...

        {
            id: 2,
            image: {
                src: "/images/tp-artblog-project2.png",
                alt: "creativelogo.png"
            },
            des: "Construction, roofing, home remodeling, home imporovment...",
            f_left: {
                textI: "From",
                textII: "$35"
            },
...

        {
            id: 3,
            image: {
                src: "/images/tp-artblog-project3.png",
                alt: "illustration-image"
            },
            des: "A Unique & Impressive Quality Article/Blog/Contact",
            f_left: {
                textI: "From",
                textII: "$50"
            },
...

        {
            id: 4,
            image: {
                src: "/images/tp-artblog-project4.png",
                alt: "powerpoint-image"
            },
            des: "An SEO Optimized Travel Blog/Articles projects",
            f_left: {
                textI: "From",
                textII: "$20"
            },
    ...
    const ProjectListII = [
        {
            id: 1,
            image: {
                src: "/images/miniartbg1.png",
                alt: "logodesign-image"
            },
            des: "A high quality articles that drives your website to high ranks",
            f_left: {
                textI: "From",
                textII: "$50"
            },
...

        {
            id: 2,
            image: {
                src: "/images/miniartbg2.png",
                alt: "logodesign-image"
            },
            des: "An engaging Content for your website",
            f_left: {
                textI: "From",
                textII: "$50"
            },
...

        {
            id: 3,
            image: {
                src: "/images/miniartbg3.png",
                alt: "logodesign-image"
            },
            des: "Content write to write a blog | SEO Article Writer (deliver in 24...)",
            f_left: {
                textI: "From",
                textII: "$100"
            },
...

        {
            id: 4,
            image: {
                src: "/images/miniartbg4.png",
                alt: "logodesign-image"
            },
            des: "A High Engaging, 100% Original and SEO Optimized Articles",
            f_left: {
                textI: "From",
                textII: "$100"
            },
...

        {
            id: 5,
            image: {
                src: "/images/miniartbg5.png",
                alt: "logodesign-image"
            },
            des: "An Original, Informative, and SEO- friendly Blog or Articles",
            f_left: {
                textI: "From",
                textII: "$49"
            },
...

        {
            id: 6,
            image: {
                src: "/images/miniartbg6.png",
                alt: "logodesign-image"
            },
            des: "Content that satisfies both human readers and SERPs",
            f_left: {
                textI: "From",
                textII: "$30"
            },
...

        {
            id: 7,
            image: {
                src: "/images/miniartbg7.png",
                alt: "logodesign-image"
            },
            des: "High Quality Articles, Blog, eBooks Covering Mental Health...",
            f_left: {
                textI: "From",
                textII: "$50"
            },
...

        {
            id: 8,
            image: {
                src: "/images/miniartbg8.png",
                alt: "logodesign-image"
            },
            des: "An SEO-optimized blog written (with KW reseearch)",
            f_left: {
                textI: "From",
                textII: "$35"
            },
...

        {
            id: 9,
            image: {
                src: "/images/miniartbg9.png",
                alt: "logodesign-image"
            },
            des: "Exceptional wine reviews wine teasting notes, and wine blogs...",
            f_left: {
                textI: "From",
                textII: "$30"
            },
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <header className="header-bg">
                ...
                <Navbar/>
                 ...
                 <ServiceSearch
                    textI = "Marketing"
                    textII = "Social Media Marketing"
                    headText = "Social Media Managment"
                    des = "Too busy? Let a social media management expert handle your accounts for you."
            ...
            <main>
                ...
                <SerFirProjectSec
                    ...
                    des="Social Media posts projects available"
                    projectList={ProjectListI}
                />

                {/* ======================== Second Section =========================== */}
                <SeSecProjectSec
                    headText = "Top minimalist Social Media Posts projects"
                ...
                {/* ======================== Third Section =========================== */}
                <SeThiProjectSec
                    headText = "Top minimalist Social Management Posts projects"
                    des="These Writter will create a simple, bold Social that makes your brand unforgettable"
                ...
                {/* ============================ Eight Section ============================ */}
                <SeEigProjectSec
                    headText="Social Media Management Related Articles"
                    projectList={ProjectListVIII}
                />

                {/* ============================ Last Section ============================ */}
                <ServiceList
                    headText="Browse Related Articels and Social Media Services"
